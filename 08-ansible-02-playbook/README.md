...
---
### Добавляем в файл prod.yml  новый play ля развертывания пакета kibana  / Также создаем в каталоге \group_vars\kibana файл vars.yml  с переменными  пакета kibana.
