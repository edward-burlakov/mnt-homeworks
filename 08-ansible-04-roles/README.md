remote## Домашнее задание к занятию "8.4. Работа с roles"
...
----
### 1) Копируем  старый проект "LESSON_8.3" в проект "LESSON_8.4" . Создаем в новой версии в каталоге playbook файл requirements.yml и заполняем его следующим содержимым:
...
###        Также разносим переменные  из старых каталогов group_vars в  каталоги vars и default. 
###         В каталог  vars помещаем те переменные, которые НЕ сможет менять пользователь, скачавший  опубликованный нами плейбук.
